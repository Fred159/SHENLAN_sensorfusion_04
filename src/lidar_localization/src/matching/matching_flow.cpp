...
bool MatchingFlow::UpdateMatching() {
    if (!matching_ptr_->HasInited()) {
        ...
        */
        ...
        // matching_ptr_->SetInitPose(init_pose); No need to run this function because the SetInitPose is included in SetGNSSPose function
        // matching_ptr_->SetInited();

        //SetScanContextPose approach
